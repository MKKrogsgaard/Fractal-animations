# Fractal animations
 Animations of the Mandelbrot set and other related fractals. Files that end in `_video_cuda.py` generate animations. They use numba cuda to parallelize the computation of whether a given pixel is in the fractal, and hence only work on NVIDIA GPUs.
